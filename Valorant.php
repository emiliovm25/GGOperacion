...
<body>
    ...
    <div class="fortnite-hero">
        ...
        <video autoplay muted loop id="fortniteVideo" class="video-bg">
            <source src="imglogo/Trailers/trailerval.mp4" type="video/mp4">
        ...
        <div class="container hero-content">
            <h1 class="fortnite-title">Valorant</h1>
            <h2 class="fortnite-subtitle">UN TIRADOR TÁCTICO POR EQUIPOS</h2>
            <p class="fortnite-cta">DISPARA, APUNTA, GANA</p>
            <a href="https://valorant.secure.dyn.riotcdn.net/channels/public/x/installer/current/live.live.ap.exe" target="_blank" rel="noopener noreferrer"
    ...
    <div class="fullwidth-news-container">
        <div class="news-inner-container">
            <div class="fortnite-news-container">
                <!-- Noticia 1 - eSports -->
                <a href="https://playvalorant.com/es-mx/news/esports/stage-2-de-vct-game-changers-latam/"
                    class="fortnite-news-card" target="_blank">
                    <div class="news-image">
                        <img src="imglogo/387d1d418dd7be0da5c1c5731eb3bf4b8f1c8095-1920x1080.jpg"
                            alt="Stage 2 de VCT Game Changers LATAM">
                    </div>
                    <div class="news-content">
                        <h3 class="news-title">Stage 2 de VCT Game Changers LATAM</h3>
                        <p class="news-body">La segunda etapa del VCT Game Changers para Latinoamérica está por
                            comenzar, con
                            equipos femeninos compitiendo por un lugar en el torneo internacional.</p>
                        <div class="news-link">Ver noticia completa →</div>
                    </div>
                </a>

                <!-- Noticia 2 - Parche -->
                <a href="https://playvalorant.com/es-mx/news/game-updates/valorant-patch-notes-10-11/"
                    class="fortnite-news-card" target="_blank">
                    <div class="news-image">
                        <img src="imglogo/82990180b8a7eed690046b52cbc95313192ad82e-1920x1080 (1).jpg"
                            alt="Notas del parche 10.11">
                    </div>
                    <div class="news-content">
                        <h3 class="news-title">Notas del parche 10.11</h3>
                        <p class="news-body">El nuevo parche trae cambios importantes al meta: ajustes a varios agentes,
                            actualizaciones de mapas y correcciones de bugs.</p>
                        <div class="news-link">Ver notas completas →</div>
                    </div>
                </a>

                <!-- Noticia 3 - Video -->
                <a href="https://www.youtube.com/watch?v=kqzhFKHIN2w" class="fortnite-news-card" target="_blank">
                    <div class="news-image">
                        <img src="https://i.ytimg.com/vi/kqzhFKHIN2w/maxresdefault.jpg" alt="Nuevo agente teaser">
                    </div>
                    <div class="news-content">
                        <h3 class="news-title">Nuevo Agente Revelado</h3>
                        <p class="news-body">Riot Games ha lanzado un teaser del próximo agente que llegará a Valorant.
                            El video
                            muestra habilidades que parecen manipular el tiempo.</p>
                        <div class="news-link">Ver video teaser →</div>
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="valorant-container">
        <div class="valorant-card">
            ...
            <div class="valorant-image">
                <img src="imglogo/agente.png" alt="Valorant Agents">
            </div>

            <!-- Content Section -->
            <div class="valorant-content">
                <h2 class="valorant-title">TUS AGENTES</h2>
                <p class="valorant-body">
                    LA CREATIVIDAD ES TU MEJOR ARMA.<br><br>
                    Más allá de las armas y las balas, podrás elegir a un agente dotado de habilidades versátiles,
                    veloces y letales con las que crearás oportunidades para sobresalir. Ningún agente se jugará igual,
                    ni ningún momento memorable se verá igual.
                </p>
                <a href="valorantcontenido.php?seccion=agentes" class="valorant-btn">VER TODOS LOS AGENTES</a>
            </div>
        </div>
    </div>
    <div class="valorant-container">
        <div class="valorant-card">
            <!-- Image Section -->
            <div class="valorant-image">
                <img src="imglogo/modoval.jpg" alt="Modos de Valorant">
            </div>

            <!-- Content Section -->
            <div class="valorant-content">
                <h2 class="valorant-title">MODOS DE JUEGO</h2>
                <p class="valorant-body">
                    CADA MODO ES UN NUEVO DESAFÍO.<br><br>
                    Desde la intensidad del Competitivo hasta la diversión de los modos por tiempo limitado, Valorant
                    ofrece experiencias únicas para todos los jugadores. Domina las reglas, adapta tus tácticas y
                    encuentra tu modo favorito para destacar.
                </p>
                <a href="valorantcontenido.php?seccion=modo" class="valorant-btn">DESCUBRIR MODOS</a>
            </div>
        </div>
    ...
    <div class="valorant-container">
        <div class="valorant-card">
            <!-- Image Section -->
            <div class="valorant-image">
                <img src="imglogo/mapa.png" alt="Valorant Agents">
            </div>

            <!-- Content Section -->
            <div class="valorant-content">
                <h2 class="valorant-title">DOMINA LOS MAPAS</h2>
                <p class="valorant-body">
                    CADA RINCÓN CUENTA UNA HISTORIA.<br><br>
                    Desde los estrechos callejones de Bind hasta las amplias zonas de Icebox, cada mapa en Valorant
                    ofrece un campo de batalla único. Conoce cada esquina, cada punto de control y cada ruta secreta
                    para convertirte en un estratega imparable.
                </p>
                <a href="valorantcontenido.php?seccion=mapas" class="valorant-btn">EXPLORAR MAPAS</a>
            </div>
        </div>
    </div>
     </div>
    ...
    <div class="valorant-card">
        <!-- Image Section -->
        <div class="valorant-image">
            <img src="imglogo/armasval.png" alt="Armas de Valorant">
        </div>

        <!-- Content Section -->
        <div class="valorant-content">
            <h2 class="valorant-title">ARSENAL DE VALORANT</h2>
            <p class="valorant-body">
                CADA ARMA TIENE SU PROPÓSITO.<br><br>
                Desde la precisión del Vandal hasta la potencia del Operator, el arsenal de Valorant ofrece opciones para cada situación de combate. Domina las estadísticas, controla el retroceso y encuentra las armas que mejor se adapten a tu estilo de juego.
            </p>
            <a href="valorantcontenido.php?seccion=armas" class="valorant-btn">EXPLORAR ARMAS</a>
        </div>
    </div>
</div>
