...
<body>
    ...
    <div class="fortnite-hero">
        ...
        <video autoplay muted loop id="fortniteVideo" class="video-bg">
            <source src="imglogo/Trailers/trailerlol.mp4" type="video/mp4">
        ...
        <div class="container hero-content">
            <h1 class="fortnite-title">LEAGUE OF LEGENDS</h1>
            <h2 class="fortnite-subtitle">UN JUEGO DE ESTRATEGIA Y HABILIDAD</h2>
            <p class="fortnite-cta">COMPITE EN EQUIPO O EN SOLITARIO</p>
            <a href="https://lol.secure.dyn.riotcdn.net/channels/public/x/installer/current/live.la1.exe" target="_blank" rel="noopener noreferrer"
    ...
    <div class="fullwidth-news-container">
        <div class="news-inner-container">
            <div class="fortnite-news-container">
                <!-- Noticia 1 - MSI 2025 -->
                <a href="https://lolesports.com/es-MX/news/msi-2025-primer"
                    class="fortnite-news-card" target="_blank">
                    <div class="news-image">
                        <img src="imglogo/MSI.jpg" alt="MSI 2025: Primer anuncio">
                    </div>
                    <div class="news-content">
                        <h3 class="news-title">MSI 2025: Primer anuncio oficial</h3>
                        <p class="news-body">Riot Games revela los primeros detalles del Mid-Season Invitational 2025, incluyendo ubicación, fechas y formato del torneo internacional.</p>
                        <div class="news-link">Ver noticia completa →</div>
                    </div>
                </a>

                <!-- Noticia 2 - Actualización de campeones -->
                <a href="https://www.youtube.com/watch?v=5roW7raKJFU"
                    class="fortnite-news-card" target="_blank">
                    <div class="news-image">
                        <img src="imglogo/actulizacion.jpg" alt="Actualización de campeones">
                    </div>
                    <div class="news-content">
                        <h3 class="news-title">Nueva actualización de campeones</h3>
                        <p class="news-body">Descubre los últimos cambios en el balance de campeones, con ajustes significativos para varios personajes del roster.</p>
                        <div class="news-link">Ver video completo →</div>
                    </div>
                </a>

                <!-- Noticia 3 - El regreso de Arena -->
                <a href="https://www.leagueoflegends.com/es-mx/news/game-updates/the-return-of-arena/"
                    class="fortnite-news-card" target="_blank">
                    <div class="news-image">
                        <img src="imglogo/arena.jpg" alt="El regreso de Arena">
                    </div>
                    <div class="news-content">
                        <h3 class="news-title">El regreso de Arena</h3>
                        <p class="news-body">El popular modo de juego Arena vuelve con nuevas mejoras, campeones adicionales y mecánicas refrescantes para una experiencia más competitiva.</p>
                        <div class="news-link">Ver detalles completos →</div>
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="valorant-container">
        <div class="valorant-card">
            ...
            <div class="valorant-image">
                <img src="imglogo/campeones.png" alt="Campeones de League of Legends">
            </div>

            <!-- Content Section -->
            <div class="valorant-content">
                <h2 class="valorant-title">TUS CAMPEONES</h2>
                <p class="valorant-body">
                    DOMINA LA GRIETA DEL INVOCADOR.<br><br>
                    Con más de 150 campeones únicos, cada uno con habilidades y estilos de juego distintos. Desde ágiles 
                    asesinos hasta poderosos tanques, encuentra el campeón que se adapte a tu estilo de juego y domina 
                    el campo de batalla con sus combos únicos y estrategias letales.
                </p>
                <a href="contenidolol.php?seccion=champions" class="valorant-btn">VER TODOS LOS CAMPEONES</a>
            </div>
        </div>
    </div>
    <div class="valorant-container">
        <div class="valorant-card">
            <!-- Image Section -->
            <div class="valorant-image">
                <img src="imglogo/modolol.png" alt="Modos de League of Legends">
            </div>
            ...
            <div class="valorant-content">
                ...
                <p class="valorant-body">
                    VARIEDAD PARA TODOS LOS ESTILOS.<br><br>
                    Desde la intensidad del Clasificatorio en la Grieta del Invocador hasta la diversión de modos 
                    temporales como ARAM o Arena. League of Legends ofrece experiencias únicas para jugadores casuales 
                    y competitivos por igual. Descubre tu modo favorito y vive nuevas aventuras en Runaterra.
                </p>
                <a href="contenidolol.php?seccion=gamemodes" class="valorant-btn">EXPLORAR MODOS</a>
            </div>
        </div>
    </div>
